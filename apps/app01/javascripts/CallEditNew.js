...
{
//We are trying to create a Dynamic ID for each row as that will help fetch it the second time
...
//The Product Information is being fetched based upon the ID tag.
